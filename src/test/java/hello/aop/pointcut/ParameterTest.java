...
//        @Before("allMember() && this(obj)") //MemberService 프록시
        @Before(value = "allMember() && this(obj)", argNames = "joinPoint,obj") //MemberService 프록시
        public void thisArgs(JoinPoint joinPoint, MemberService obj) {
            log.info("[this]{}, obj={}", joinPoint.getSignature(), obj.getClass());
        }

        @Before("allMember() && target(obj)") //MemberService 실제 대상
